...
static void VypisDruhySeznam(IEnumerable<KeyValuePair<int, List<char>>> zoznamByPocet)
{
...
static IEnumerable<KeyValuePair<int, List<char>>> UsporadejPodlePoctu(IEnumerable<KeyValuePair<char, int>> seznam)
{
...
static void Vypis(IEnumerable<KeyValuePair<char, int>> seznam)
{
...
static IEnumerable<KeyValuePair<char, int>> SpocitejVyskytPismen(string vstup)
{
